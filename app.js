...
var gameView = new _viewsGameView2['default'](gameModel);
var gameController = new _controllersGameController2['default'](gameModel, gameView);
...
},{"./controllers/GameController":91,"./models/Game":99,"./views/GameView":103,"babelify/polyfill":89}],2:[function(require,module,exports){
(function (global){
"use strict";
...
var _libAI = require('../lib/AI');

var _libAI2 = _interopRequireDefault(_libAI);
...
var GameController = (function () {
	...
	_createClass(GameController, [{
		key: 'onHumanPlayerRequestedShoot',
		value: function onHumanPlayerRequestedShoot(eventName, data) {
			var _data$coordinate = data.coordinate;
			var x = _data$coordinate.x;
			var y = _data$coordinate.y;
		...
		value: function giveTurnTo(player) {
			...
			if (this.isComputer(player)) {
				(function () {
					var coordinate = _this.ai.chooseCoordinate();

					setTimeout(function () {
						var result = _this.model.humanPlayer.takeHit(coordinate);
						var hit = result.hit;
						var sunk = result.sunk;

						_this.ai.updateHitMapAtCoordinate(coordinate, hit, sunk);
		...
		key: 'getOpponent',
		value: function getOpponent(player) {
			return this.isHuman(player) ? this.model.computerPlayer : this.model.humanPlayer;
		}
	}, {
		key: 'checkWinner',
		value: function checkWinner() {
			var humanPlayerIsSunk = this.model.humanPlayer.isSunk();
			var computerPlayerIsSunk = this.model.computerPlayer.isSunk();

			if (!humanPlayerIsSunk && !computerPlayerIsSunk) {
				return false;
			}
		...
		key: 'getInfoMessage',
		value: function getInfoMessage(data, player) {
			var hit = data.hit;
			var sunk = data.sunk;
			var ship = data.ship;

			var opponentName = this.getOpponent(player).name;
			var message = '';
		...
		key: 'isHuman',
		value: function isHuman(player) {
			return player === this.model.humanPlayer;
		}
	}, {
		key: 'isComputer',
		value: function isComputer(player) {
...
},{"../constants":90,"../lib/AI":92,"../models/Coordinate":98}],92:[function(require,module,exports){
'use strict';
...
var AI = (function () {
	...
	_createClass(AI, [{
		key: 'chooseCoordinate',
		value: function chooseCoordinate() {
			var cellsNotTried = this.getFlattenedHitMap().filter(function (cell) {
				return cell.tried === false;
			});
			var index = (0, _helpers.getRandomInt)(0, cellsNotTried.length - 1);
			var chosenCell = cellsNotTried[index];
			return chosenCell.coordinate;
		}
	}, {
		key: 'updateHitMapAtCoordinate',
		value: function updateHitMapAtCoordinate(coordinate, hit, sunk) {
			var x = coordinate.x;
			var y = coordinate.y;

			var cell = this.hitMap[x][y];
		...
		key: 'getFlattenedHitMap',
		value: function getFlattenedHitMap() {
			return this.hitMap.reduce(function (flattenedHitMap, column) {
				return flattenedHitMap.concat(column);
			}, []);
		}
	}]);
...
},{"../models/Coordinate":98,"./helpers":96}],93:[function(require,module,exports){
"use strict";
...
var EventEmitter = (function () {
	...
	_createClass(EventEmitter, [{
		...
		value: function off(eventName, callback) {
			...
			this._$listeners.forEach(function (listener, index) {
				if (listener.name === eventName && listener.callback === callback) {
					_this._$listeners.splice(index, 1);
				}
			});
			return this;
		}
		...
		value: function emit(eventName, data) {
			...
			this._$listeners.filter(function (listener) {
				return listener.name === eventName;
			}).forEach(function (listener) {
				return listener.callback(eventName, data, _this2);
			});
			return this;
		}
	}, {
		key: "proxy",
		value: function proxy(eventName, data) {
...
var Model = (function (_EventEmitter) {
	...
	_createClass(Model, [{
		key: '_$createGettersAndSetters',
		value: function _$createGettersAndSetters(attributes) {
			var _this = this;

			var _loop = function (attributeKey) {

				Object.defineProperty(_this, attributeKey, {
					get: function get() {
						return attributes[attributeKey];
					},
					set: function set(value) {
						var oldValue = this[attributeKey];

						if (!this._$attributeHasChanged(value, oldValue)) {
							return;
						}
						...
						this.emit('changed', eventPayload).emit('changed:' + attributeKey, eventPayload);
				...
				_this[attributeKey] = attributeValue;
			};
		...
		key: '_$attributeHasChanged',
		value: function _$attributeHasChanged(value, oldValue) {
...
},{"./EventEmitter":93}],95:[function(require,module,exports){
'use strict';
...
var View = (function (_EventEmitter) {
	function View(model) {
		var element = arguments[1] === undefined ? document.body : arguments[1];
	...
	_createClass(View, [{
		...
		value: function delegate(eventName, selector, callback) {
			...
			function handleEvent(event) {
				var isClassName = selector.charAt(0) === '.';
...
},{"./EventEmitter":93}],96:[function(require,module,exports){
'use strict';
...
var Board = (function (_Model) {
	function Board(attributes) {
		_classCallCheck(this, Board);

		_get(Object.getPrototypeOf(Board.prototype), 'constructor', this).call(this, Object.assign({
	...
	_createClass(Board, [{
		key: 'deployShip',
		value: function deployShip(ship, startCoordinate, direction) {
			if (!this.canPlaceShip(ship, startCoordinate, direction)) {
				return false;
			}

			var xStart = startCoordinate.x;
			var yStart = startCoordinate.y;

			if (direction === 'x') {
				for (var x = xStart, partIndex = 0; x < xStart + ship.size; x++, partIndex++) {
					var coordinate = new _Coordinate2['default']({ x: x, y: yStart });
					this.setAtCoordinate(coordinate, ship.getPartAtIndex(partIndex));
				}
			}

			if (direction === 'y') {
				var yEnd = yStart + ship.size;
				if (yEnd > this.size - 1) {
					return false;
				}
				for (var y = yStart, partIndex = 0; y < yStart + ship.size; y++, partIndex++) {
					var coordinate = new _Coordinate2['default']({ x: xStart, y: y });
					this.setAtCoordinate(coordinate, ship.getPartAtIndex(partIndex));
				}
			}
		...
		key: 'canPlaceShip',
		value: function canPlaceShip(ship, startCoordinate, direction) {
			var xStart = startCoordinate.x;
			var yStart = startCoordinate.y;

			if (direction === 'x') {
				var xEnd = xStart + ship.size;
				if (xEnd > this.size - 1) {
					return false;
				}
		...
		key: 'getAtCoordinate',
		value: function getAtCoordinate(coordinate) {
			var x = coordinate.x;
			var y = coordinate.y;
		...
		key: 'setAtCoordinate',
		value: function setAtCoordinate(coordinate, value) {
			var x = coordinate.x;
			var y = coordinate.y;
		...
		key: 'hasShipPartAtCoordinate',
		value: function hasShipPartAtCoordinate(coordinate) {
			return this.getAtCoordinate(coordinate) instanceof _ShipPart2['default'];
		}
	}, {
		key: 'isCellMissed',
		value: function isCellMissed(coordinate) {
			return this.getAtCoordinate(coordinate) === _constants.CELL_MISSED;
		}
	}, {
		key: 'takeHit',
		value: function takeHit(coordinate) {
			var hasShipPart = this.hasShipPartAtCoordinate(coordinate);
			var cellContent = this.getAtCoordinate(coordinate);
			var alreadyHit = this.isCellMissed(coordinate) || hasShipPart && !cellContent.isIntact();
			...
			if (!hasShipPart) {
				this.setAtCoordinate(coordinate, _constants.CELL_MISSED);
			} else {
				var shipPart = cellContent;
				shipPart.takeHit();
				hit = true;
...
},{"../constants":90,"../lib/Model":94,"./Coordinate":98,"./ShipPart":102}],98:[function(require,module,exports){
'use strict';
...
var Coordinate = (function (_Model) {
	function Coordinate(attributes) {
		_classCallCheck(this, Coordinate);

		_get(Object.getPrototypeOf(Coordinate.prototype), 'constructor', this).call(this, Object.assign({
			x: 0,
			y: 0
		}, attributes));
	}

	_inherits(Coordinate, _Model);
	...
	_createClass(Coordinate, [{
		...
		value: function random(size) {
			var x = (0, _libHelpers.getRandomInt)(0, size - 1);
			var y = (0, _libHelpers.getRandomInt)(0, size - 1);
...
},{"../lib/Model":94,"../lib/helpers":96}],99:[function(require,module,exports){
'use strict';
...
var Game = (function (_Model) {
	function Game(attributes) {
		...
		_get(Object.getPrototypeOf(Game.prototype), 'constructor', this).call(this, Object.assign({
			humanPlayer: new _Player2['default']({ name: 'Neo' }),
			computerPlayer: new _Player2['default']({ name: 'Agent Smith' }),
...
},{"../lib/Model":94,"./Board":97,"./Player":100}],100:[function(require,module,exports){
'use strict';
...
var Player = (function (_Model) {
	function Player(attributes) {
		...
		_get(Object.getPrototypeOf(Player.prototype), 'constructor', this).call(this, Object.assign({
	...
	_createClass(Player, [{
		key: 'deployFleet',
		value: function deployFleet() {
			this.fleet.forEach(this.deployShip.bind(this));
		}
	}, {
		key: 'deployShip',
		value: function deployShip(ship) {
			...
			do {
				...
				startCoordinate = _Coordinate2['default'].random(this.boardSize);
				direction = (0, _libHelpers.getRandomBoolean)() ? 'x' : 'y';
...
},{"../constants":90,"../lib/Model":94,"../lib/helpers":96,"./Board":97,"./Coordinate":98,"./Ship":101}],101:[function(require,module,exports){
'use strict';
...
var Ship = (function (_Model) {
	function Ship(attributes) {
		_classCallCheck(this, Ship);

		_get(Object.getPrototypeOf(Ship.prototype), 'constructor', this).call(this, Object.assign({
		...
		function initParts(ship, size) {
			...
			for (var i = 0; i < size; i++) {
				parts[i] = new _ShipPart2['default']({ ship: ship });
			}
			return parts;
		}
	}

	_inherits(Ship, _Model);

	_createClass(Ship, [{
		key: 'getPartAtIndex',
		value: function getPartAtIndex(index) {
			return this.parts[index];
		}
	}, {
		key: 'isIntact',
		value: function isIntact() {
			return this.parts.every(function (part) {
				return part.isIntact();
			});
		}
	}, {
		key: 'isHit',
...
},{"../lib/Model":94,"./ShipPart":102}],102:[function(require,module,exports){
'use strict';
...
var ShipPart = (function (_Model) {
	function ShipPart(attributes) {
		_classCallCheck(this, ShipPart);

		_get(Object.getPrototypeOf(ShipPart.prototype), 'constructor', this).call(this, Object.assign({
			ship: null,
			state: INTACT
		}, attributes));
	}

	_inherits(ShipPart, _Model);
...
},{"../lib/Model":94}],103:[function(require,module,exports){
'use strict';
...
var GameView = (function (_View) {
	...
	_createClass(GameView, [{
		...
		key: 'onPlayerShot',
		value: function onPlayerShot() {
			this.render();
		}
	}, {
		key: 'onPlayerActivationChanged',
		value: function onPlayerActivationChanged() {
			this.render();
		}
	}, {
		key: 'render',
...
},{"../constants":90,"../lib/View":95,"../models/Coordinate":98}]},{},[1]);
